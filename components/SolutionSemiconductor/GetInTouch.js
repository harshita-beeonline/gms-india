    ...
    <>
      ...
      <div className={styles["india-first-exclusive-section"]}>
        <div className={styles["india-first-exclusive-content"]}>
          ...
          <p>
            GMS-India is proud to present over 4000 sq/ft of in-house clean rooms
            for all your prototyping and testing needs, equipped with state-of-the-art
            equipment and designed to adhere to FS209E Class 8 and ISO Class 3 standards,
            ensuring we deliver the best value to our customers.
          </p>
          <button onClick={() => setIsPopupOpen(true)}>Talk to Our Expert</button>
        </div>
      </div>
        ...
        <div className={styles["getin-touch-left-right-part"]}>
          <div className={styles["getin-touch-left-part"]}>
            ...
            <div className={styles["details-and-button"]}>
              <p>
                Welcome to Global Marketing Services (GMS). We are a leading solution
                provider based out of Bangalore, offering a wide range of equipment,
                individual components, and materials for EV Batteries, PCB's, Thin Films,
                Semiconductors, Microelectronics, MEMS, LED, and Solar applications for
                device manufacturing and research organizations in India.
              </p>
              <button onClick={() => setIsPopupOpen(true)}>Let’s Connect</button>
            </div>
          </div>

          <div className={styles["getin-touch-right-part"]}>
            <div className={styles["experts-image"]}>
              <Image src={expertsimage} alt="Experts" />
            </div>
          </div>
        </div>
      </div>
      ...
      {isPopupOpen && (
        <div className={styles["enquire-popup-overlay"]}>
          <div className={styles["enquire-popup-content"]}>
            ...
            <form onSubmit={formik.handleSubmit} className={styles["footer-inputs-form"]}>
              <div className={styles["footer-both-inputs"]}>
                ...
                <div className={styles["input-error"]}>
                  ...
                  {formik.touched.company && formik.errors.company && (
                    <div className={styles["error-message"]}>{formik.errors.company}</div>
                  )}
                </div>
              </div>
              ...
              <div className={styles["footer-both-inputs"]}>
                <div className={styles["input-error"]}>
                  ...
                  {formik.touched.description && formik.errors.description && (
                    <div className={styles["error-message"]}>{formik.errors.description}</div>
                  )}
                </div>
              </div>
