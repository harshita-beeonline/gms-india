...
const SemiconductorBanner = () => {
  const cardData = [
    ...
    },
    {
      title: "Components",
      details:
        "We provide premium products from leading companies, ensuring reliable components that meet the highest standards and delivering dependable, customer-focused support through after-sales service.",
    },
    {
      title: "Custom Solutions",
      details:
        "With over two decades of experience, we provide personalized solutions, offering innovative approaches and ideas that consistently go beyond conventional thinking to meet unique requirements.",
    },
  ];
  return (
    <>
        ...
        <div className={styles["semiconductor-left-right-content"]}>
          ...
          <div className={styles["semiconductor-right-content"]}>
            <div className={styles["solution-semiconductor"]}>
              <h5>Solutions</h5>
              <h5 className={styles["have-divider"]}> Semiconductors</h5>
            </div>
          </div>
        </div>
      </div>
...
export default SemiconductorBanner;
