...
const timelineEvents = [
  {
    ...
    title: "Established",
    icon: Established,
    description: "Focus was semiconductor materials and equipment",
  },
  {
    year: 2003,
    ...
    icon: Cpu,
    description:
      "Received 1st order for MEMS Equipment from Department of Space",
  },
  {
    year: 2009,
    title: "Space Solar",
    icon: Sun,
    description:
      "Received Largest Order for Space Grade Solar Cells from department of Space worth 10M USD",
  },
  {
    year: 2018,
    title: "EV Business",
  ...
  },
  {
    ...
    title: "New Office",
    icon: New_Office,
    description: "Moved into bigger office space",
  },
  {
    year: 2022,
    title: "Cleanroom",
    icon: Cleanroom,
    description:
      "Setup facility with Lithography, assembly and packaging for prototyping, demonstration and Skill development",
  },
  {
    year: 2025,
    title: "Cleanroom & Utilities Business",
    icon: Business,
    description: "Diversified into a new segment",
  },
];
    ...
    <section className={styles.timelineSection}>
      <div className={styles.timelineContainer}>
        ...
        <motion.div
          ...
          initial={{ opacity: 0, x: -100 }} // 👈 negative X = from left side
          animate={{ opacity: 1, x: 0 }}
          exit={{ opacity: 0, x: 50 }} // optional for reverse transition
          transition={{ duration: 0.6, ease: "easeOut" }} // slightly smoother duration
        >
